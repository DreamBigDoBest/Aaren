! function(t, e, r) {
	...
	function e(t, e) {
	...
	}(r = r || {}).utils = {}, r.utils.makeEventEmitter = function(t, e) {
		t.prototype.allowedEvents_ = e, t.prototype.on = function(t, e, r) {
			...
			for (var e = this.eventListeners_[t] || [], r = 0; r < e.length; r++) e[r].callback.apply(e[r].context, Array.prototype.slice.call(arguments, 1))
		...
		return i
	}, r.utils.setTextContent = function(t, e) {
		t.innerHTML = "", t.appendChild(document.createTextNode(e))
	}, r.utils.on = function(t, e, r, n) {
		t.addEventListener ? t.addEventListener(e, r, n || !1) : t.attachEvent && t.attachEvent("on" + e, r)
	}, r.utils.off = function(t, e, r, n) {
		t.removeEventListener ? t.removeEventListener(e, r, n || !1) : t.detachEvent && t.detachEvent("on" + e, r)
	}, r.utils.preventDefault = function(t) {
		t.preventDefault ? t.preventDefault() : t.returnValue = !1
	}, r.utils.stopPropagation = function(t) {
		t.stopPropagation ? t.stopPropagation() : t.cancelBubble = !0
	}, r.utils.stopEvent = function(t) {
		r.utils.preventDefault(t), r.utils.stopPropagation(t)
	}, r.utils.stopEventAnd = function(t) {
		return function(e) {
			return t(e), r.utils.stopEvent(e), !1
		}
	}, r.utils.trim = function(t) {
		return t.replace(/^\s+/g, "").replace(/\s+$/g, "")
	}, r.utils.stringEndsWith = function(t, e) {
		for (var r = "string" == typeof e ? [e] : e, n = 0; n < r.length; n++) {
			e = r[n];
			if (-1 !== t.indexOf(e, t.length - e.length)) return !0
		}
		return !1
	}, r.utils.assert = function(t, e) {
		if (!t) throw new Error(e || "assertion error")
	}, r.utils.log = function() {
		if ("undefined" != typeof console && void 0 !== console.log) {
			for (var t = ["Firepad:"], e = 0; e < arguments.length; e++) t.push(arguments[e]);
	...
	}(), (r = r || {}).TextOperation = function() {
		"use strict";
		var t = r.TextOp,
			e = r.utils;

		function n() {
			if (!this || this.constructor !== n) return new n;
		...
		return n.prototype.equals = function(t) {
			...
			return !0
		}, n.prototype.retain = function(e, r) {
		...
		}, n.prototype.insert = function(e, r) {
			...
			for (var t = new n, e = 0; e < this.ops.length; e++) this.ops[e].isRetain() ? t.retain(this.ops[e].chars, this.ops[e].attributes) : this.ops[e].isInsert() ? t.insert(this.ops[e].text, this.ops[e].attributes) : t.delete(this.ops[e].chars);
			return t
		}, n.prototype.toString = function() {
			return (Array.prototype.map || function(t) {
				for (var e = [], r = 0, n = this.length; r < n; r++) e[r] = t(this[r]);
				return e
			}).call(this.ops, function(t) {
				return t.isRetain() ? "retain " + t.chars : t.isInsert() ? "insert '" + t.text + "'" : "delete " + t.chars
			}).join(", ")
		}, n.prototype.toJSON = function() {
			for (var t = [], e = 0; e < this.ops.length; e++) this.ops[e].hasEmptyAttributes() || t.push(this.ops[e].attributes), "retain" === this.ops[e].type ? t.push(this.ops[e].chars) : "insert" === this.ops[e].type ? t.push(this.ops[e].text) : "delete" === this.ops[e].type && t.push(-this.ops[e].chars);
			return 0 === t.length && t.push(0), t
		}, n.fromJSON = function(t) {
			for (var r = new n, i = 0, o = t.length; i < o; i++) {
				var s = t[i],
					a = {};
				"object" == typeof s && (a = s, s = t[++i]), "number" == typeof s ? s > 0 ? r.retain(s, a) : r.delete(-s) : (e.assert("string" == typeof s), r.insert(s, a))
			}
			return r
		}, n.prototype.apply = function(t, r, n) {
			...
			for (var i, o, s = [], a = 0, h = 0, c = this.ops, u = 0, l = c.length; u < l; u++) {
				...
				if (p.isRetain()) {
					...
					for (s[a++] = p.text, i = 0; i < p.text.length; i++) {
						var g = {};
						for (o in p.attributes) g[o] = p.attributes[o], e.assert(!1 !== g[o]);
						n.push(g)
					} else h += p.chars
			}
			...
			for (var e = 0, r = new n, i = this.ops, o = 0, s = i.length; o < s; o++) {
				var a = i[o];
				a.isRetain() ? (r.retain(a.chars), e += a.chars) : a.isInsert() ? r.delete(a.text.length) : (r.insert(t.slice(e, e + a.chars)), e += a.chars)
			}
			return r
		}, n.prototype.compose = function(t) {
			...
			for (var r, i = new n, o = this.clone().ops, s = t.clone().ops, a = 0, h = 0, c = o[a++], u = s[h++]; void 0 !== c || void 0 !== u;)
				if (c && c.isDelete()) i.delete(c.chars), c = o[a++];
				else if (u && u.isInsert()) i.insert(u.text, u.attributes), u = s[h++];
			else {
				...
				if (c.isRetain() && u.isRetain()) r = e(c.attributes, u.attributes), c.chars > u.chars ? (i.retain(u.chars, r), c.chars -= u.chars, u = s[h++]) : c.chars === u.chars ? (i.retain(c.chars, r), c = o[a++], u = s[h++]) : (i.retain(c.chars, r), u.chars -= c.chars, c = o[a++]);
				else if (c.isInsert() && u.isDelete()) c.text.length > u.chars ? (c.text = c.text.slice(u.chars), u = s[h++]) : c.text.length === u.chars ? (c = o[a++], u = s[h++]) : (u.chars -= c.text.length, c = o[a++]);
				else if (c.isInsert() && u.isRetain()) r = e(c.attributes, u.attributes, !0), c.text.length > u.chars ? (i.insert(c.text.slice(0, u.chars), r), c.text = c.text.slice(u.chars), u = s[h++]) : c.text.length === u.chars ? (i.insert(c.text, r), c = o[a++], u = s[h++]) : (i.insert(c.text, r), u.chars -= c.text.length, c = o[a++]);
				else {
			...
			return i
		}, n.prototype.shouldBeComposedWith = function(t) {
		...
		}, n.prototype.shouldBeComposedWithInverted = function(t) {
			if (this.isNoop() || t.isNoop()) return !0;
			var e = o(this),
				r = o(t),
				n = i(this),
		...
		}, n.transformAttributes = function(t, r) {
			var n, i = {},
				o = {},
				s = {};
			for (n in t) s[n] = !0;
			...
			for (var r = new n, i = new n, o = t.clone().ops, s = e.clone().ops, a = 0, h = 0, c = o[a++], u = s[h++]; void 0 !== c || void 0 !== u;)
				if (c && c.isInsert()) r.insert(c.text, c.attributes), i.retain(c.text.length), c = o[a++];
				else if (u && u.isInsert()) r.retain(u.text.length), i.insert(u.text, u.attributes), u = s[h++];
			else {
				...
				if (c.isRetain() && u.isRetain()) {
					var p = n.transformAttributes(c.attributes, u.attributes);
					c.chars > u.chars ? (l = u.chars, c.chars -= u.chars, u = s[h++]) : c.chars === u.chars ? (l = u.chars, c = o[a++], u = s[h++]) : (l = c.chars, u.chars -= c.chars, c = o[a++]), r.retain(l, p[0]), i.retain(l, p[1])
				} else if (c.isDelete() && u.isDelete()) c.chars > u.chars ? (c.chars -= u.chars, u = s[h++]) : c.chars === u.chars ? (c = o[a++], u = s[h++]) : (u.chars -= c.chars, c = o[a++]);
				else if (c.isDelete() && u.isRetain()) c.chars > u.chars ? (l = u.chars, c.chars -= u.chars, u = s[h++]) : c.chars === u.chars ? (l = u.chars, c = o[a++], u = s[h++]) : (l = c.chars, u.chars -= c.chars, c = o[a++]), r.delete(l);
				else {
		...
		n.prototype.getAttachedObject = function() {
		...
		return s.prototype.insertAnnotatedSpan = function(r, n) {
			...
			0 !== t.length && this.wrapOperation_(t, function(r, n) {
				...
				var i = new a(0, o),
					s = i;
				for (t.pos > r && (s.next = new a(t.pos - r, n.annotation), s = s.next); t.end() > r + n.length;) r += n.length, n = n.next;
			...
			null !== h.start ? (r = h.end.next, h.end.next = null) : r = h.succ;
			var c = e(h.startPos, h.start),
				u = !1,
				l = !1;
			if (c) {
				var p;
				for (this.mergeNodesWithSameAnnotations_(c), h.pred && h.pred.annotation.equals(c.annotation) ? (u = !0, c.length += h.pred.length, h.beforePred.next = c, p = h.predPos) : (h.beforeStart.next = c, p = h.startPos); c.next;) s.push(new i(p, c)), p += c.length, c = c.next;
				h.succ && h.succ.annotation.equals(c.annotation) ? (c.length += h.succ.length, l = !0, c.next = h.succ.next) : c.next = r, s.push(new i(p, c))
			} else h.pred && h.succ && h.pred.annotation.equals(h.succ.annotation) ? (u = !0, l = !0, c = new a(h.pred.length + h.succ.length, h.pred.annotation), h.beforePred.next = c, c.next = h.succ.next, s.push(new i(h.startPos - h.pred.length, c))) : h.beforeStart.next = r;
			u && o.push(new n(h.predPos, h.pred));
			for (var d = h.startPos, f = h.start; null !== f;) o.push(new n(d, f)), d += f.length, f = f.next;
			l && o.push(new n(d, h.succ)), this.changeHandler_(o, s)
		}, s.prototype.getAffectedNodes_ = function(t) {
			for (var e = {}, r = null, n = this.head_, i = n.next, o = 0; null !== i && t.pos >= o + i.length;) o += i.length, r = n, n = i, i = i.next;
			if (null === i && (0 !== t.length || t.pos !== o)) throw new Error("Span start exceeds the bounds of the AnnotationList.");
			for (e.startPos = o, 0 === t.length && t.pos === o ? e.start = null : e.start = i, e.beforeStart = n, o === t.pos && o > 0 ? (e.pred = n, e.predPos = o - n.length, e.beforePred = r) : e.pred = null; null !== i && t.end() > o;) o += i.length, n = i, i = i.next;
			...
			if (t)
				for (var e = null, r = t; r;) e && e.annotation.equals(r.annotation) ? (e.length += r.length, e.next = r.next) : e = r, r = r.next
		}, s.prototype.forEach = function(t) {
			for (var e = this.head_.next; null !== e;) t(e.length, e.annotation, e.attachedObject), e = e.next
		}, s.prototype.getAnnotatedSpansForPos = function(t) {
			for (var e = 0, r = this.head_.next, i = null; null !== r && e + r.length <= t;) e += r.length, i = r, r = r.next;
			if (null === r && e !== t) throw new Error("pos exceeds the bounds of the AnnotationList");
			var o = [];
			return e === t && i && o.push(new n(e - i.length, i)), r && o.push(new n(e, r)), o
			...
			for (var t = 0, r = this.head_.next, n = null; null !== r;) n && e(!n.annotation.equals(r.annotation)), n = r, r = r.next, t++;
			return t
	...
	}(), (r = r || {}).FirebaseAdapter = function(t) {
		"undefined" == typeof firebase && "function" == typeof require && "function" != typeof Firebase && (firebase = require("firebase"));
		var e = r.TextOperation,
			n = r.utils;
		...
		n.makeEventEmitter(i, ["ready", "cursor", "operation", "ack", "retry"]), i.prototype.dispose = function() {
			var t = this;
			this.ready_ ? (this.removeFirebaseCallbacks_(), this.userRef_ && (this.userRef_.child("cursor").remove(), this.userRef_.child("color").remove()), this.ref_ = null, this.document_ = null, this.zombie_ = !0) : this.on("ready", function() {
				t.dispose()
			})
			...
			if (this.ready_) {
				...
				this.sent_ = {
					...
					function t(i, o) {
						r.ref_.child("history").child(i).transaction(function(t) {
							if (null === t) return o
						}, function(s, a, h) {
							if (s) {
								if ("disconnect" !== s.message) throw n.log("Transaction failure!", s), s;
								r.sent_ && r.sent_.id === i ? setTimeout(function() {
									t(i, o)
								}, 0) : e && e(s, !1)
							} else e && e(null, a)
						}, !1)
			...
			this.ref_.child("checkpoint").once("value", function(e) {
				if (!t.zombie_) {
					...
					null != n && null != r && null !== i ? (t.pendingReceivedRevisions_[r] = {
						...
						for (var e = 0, r = 1; r < t.length; r++) e *= s.length, e += s.indexOf(t[r]);
						return e
			...
			for (var t = a(this.revision_), e = this.pendingReceivedRevisions_; null != e[t];) {
				...
				r ? this.document_ = this.document_.compose(r.operation) : n.log("Invalid operation.", this.ref_.toString(), t, e[t]), delete e[t], this.revision_++, t = a(this.revision_)
			}
			...
			for (var t = this.pendingReceivedRevisions_, e = a(this.revision_), r = !1; null != t[e];) {
				this.revision_++;
			...
			r && (this.sent_ = null, this.trigger("retry"))
		...
		return i
	}(), (r = r || {}).RichTextToolbar = function(t) {
		var e = r.utils;

		function n(t) {
			this.imageInsertionUI = t, this.element_ = this.makeElement_()
		}
		return e.makeEventEmitter(n, ["bold", "italic", "underline", "strike", "font", "font-size", "color", "left", "center", "right", "unordered-list", "ordered-list", "todo-list", "indent-increase", "indent-decrease", "undo", "redo", "insert-image"]), n.prototype.element = function() {
			return this.element_
		}, n.prototype.makeButton_ = function(t, r) {
			var n = this;
			r = r || t;
		...
		}, n.prototype.makeElement_ = function() {
		...
		}, n.prototype.makeFontDropdown_ = function() {
		...
		}, n.prototype.makeFontSizeDropdown_ = function() {
		...
		}, n.prototype.makeColorDropdown_ = function() {
		...
		}, n.prototype.makeDropdown_ = function(t, r, n, i) {
			i = i || "";
			var o = this,
				s = e.elt("a", t + " ▾", {
	...
	}(), (r = r || {}).WrappedOperation = function(t) {
		"use strict";
		...
		return e.prototype.add = function(t, e) {
			if ("undoing" === this.state) this.redoStack.push(t), this.dontCompose = !0;
	...
	}(), (r = r || {}).EditorClient = function() {
		"use strict";
		var t = r.Client,
			e = r.Cursor,
			n = r.UndoManager,
			i = r.WrappedOperation;
		...
		function a(r, i) {
			t.call(this), this.serverAdapter = r, this.editorAdapter = i, this.undoManager = new n, this.clients = {};
			var o = this;
		...
		return o.prototype.invert = function() {
			...
			function(t, e) {
				...
				var r = this.cursor;
				this.updateCursor();
				var n, s = this.undoManager.undoStack.length > 0 && e.shouldBeComposedWithInverted((n = this.undoManager.undoStack, n[n.length - 1]).wrapped),
		...
		var n = function() {
			...
			return i = n, (o = [{
				...
				value: function(t) {
					var e, n, i, o, s, a, h;
					return t.data ? ("insertLines" === (o = (n = t.data).action) || "removeLines" === o ? (h = n.lines.join("\n") + "\n", n.action.replace("Lines", "")) : (h = n.text.replace(this.aceDoc.getNewLineCharacter(), "\n"), n.action.replace("Text", "")), a = this.indexFromPos(n.range.start)) : (h = t.lines.join("\n"), a = this.indexFromPos(t.start)), s = this.lastDocLines.join("\n").length - a, "remove" === t.action && (s -= h.length), i = (new r.TextOperation).retain(a).insert(h).retain(s), e = (new r.TextOperation).retain(a).delete(h).retain(s), "remove" === t.action ? [e, i] : [i, e]
				}
			}, {
				key: "applyOperationToACE",
				value: function(t) {
					var e, r, n, i, o, s, a, h;
					for (r = 0, n = 0, i = (a = t.ops).length; n < i; n++)(o = a[n]).isRetain() ? r += o.chars : o.isInsert() ? (this.aceDoc.insert(this.posFromIndex(r), o.text), r += o.text.length) : o.isDelete() && (e = this.posFromIndex(r), h = this.posFromIndex(r + o.chars), s = this.aceRange.fromPoints(e, h), this.aceDoc.remove(s));
				...
				value: function(t) {
					var e, r, n, i, o;
					for (o = e = 0, r = (i = this.aceDoc.$lines).length; e < r && !(t <= (n = i[o]).length); o = ++e) t -= n.length + 1;
					return {
						row: o,
						column: t
					}
				...
				value: function(t, e) {
					var r, n, i, o;
					for (null == e && (e = this.lastDocLines), n = 0, r = i = 0, o = t.row; 0 <= o ? i < o : i > o; r = 0 <= o ? ++i : --i) n += this.lastDocLines[r].length + 1;
					return n + t.column
				}
			}, {
				key: "getValue",
				...
				value: function() {
					var t, e, n;
					try {
						n = this.indexFromPos(this.aceSession.selection.getRange().start, this.aceDoc.$lines), e = this.indexFromPos(this.aceSession.selection.getRange().end, this.aceDoc.$lines)
					} catch (r) {
						r;
						try {
							n = this.indexFromPos(this.lastCursorRange.start), e = this.indexFromPos(this.lastCursorRange.end)
						} catch (r) {
							t = r, console.log("Couldn't figure out the cursor range:", t, "-- setting it to 0:0."), n = 0, e = 0
						}
					}
					if (n > e) {
						var i = [e, n];
				...
				key: "trigger",
				value: function(t) {
					for (var e, r, n = arguments.length, i = new Array(n > 1 ? n - 1 : 0), o = 1; o < n; o++) i[o - 1] = arguments[o];
		...
		return n.prototype.ignoreChanges = !1, n
	}.call(void 0);
	var r, n = function(t, e, r) {
		...
		o = function() {
			...
			return t.prototype.detach = function() {
				...
				o === s ? (u = u.replace("selection", "cursor"), h = n(u, "transparent", e), c = i.call(this, u, h)) : (h = n(u, e, e), c = i.call(this, u, h)), 0 == c && console.log("Monaco Adapter: Failed to add some css style.\nPlease make sure you're running on supported environment.");
				...
				if (!this.ignoreChanges) {
					...
					t.changes.reverse().forEach(function(t) {
						var r = e.operationFromMonacoChanges(t, n, i);
						i += r[0].targetLength - r[0].baseLength, e.trigger.apply(e, ["change"].concat(r))
	...
	return r.MonacoAdapter = o, (r = r || {}).AttributeConstants = {
		BOLD: "b",
		ITALIC: "i",
		UNDERLINE: "u",
		STRIKE: "s",
		...
		return e.prototype.register = function(t, e) {
			r.utils.assert(e.render, "Entity options should include a 'render' function!"), r.utils.assert(e.fromElement, "Entity options should include a 'fromElement' function!"), this.entities_[t] = e
			...
			if (e || (e = t.nodeName.toLowerCase()), e && this.entities_[e]) {
				var n = this.entities_[e].fromElement(t);
				return new r.Entity(e, n)
			}
		}, e.prototype.tryRenderToElement_ = function(t, e, n) {
			var i = t.type,
				o = t.info;
			if (this.entities_[i] && this.entities_[i][e]) {
				var s = r.document || window && window.document,
					a = this.entities_[i][e](o, n, s);
				if (a) {
					if ("string" == typeof a) {
						var h = (r.document || document).createElement("div");
						return h.innerHTML = a, h.childNodes[0]
					}
					if ("object" == typeof a) return r.utils.assert(void 0 !== a.nodeType, "Error rendering " + i + " entity.  render() function must return an html string or a DOM element."), a
				}
			}
		...
		var t = r.AttributeConstants.ENTITY_SENTINEL,
			e = t + "_";
		...
		return n.prototype.toAttributes = function() {
			var r = {};
			for (var n in r[t] = this.type, this.info) r[e + n] = this.info[n];
			return r
		}, n.fromAttributes = function(r) {
			var i = r[t],
				o = {};
			for (var s in r) 0 === s.indexOf(e) && (o[s.substr(e.length)] = r[s]);
			return new n(i, o)
		}, n
	}(), (r = r || {}).RichTextCodeMirror = function() {
		var t = r.AnnotationList,
			e = r.Span,
			n = r.utils,
			i = r.AttributeConstants,
			o = {
				c: "color",
				bc: "background-color",
				fs: "font-size",
		...
		n.makeEventEmitter(a, ["change", "attributesChange", "newLine"]);
		var h = r.sentinelConstants.LINE_SENTINEL_CHARACTER,
			c = r.sentinelConstants.ENTITY_SENTINEL_CHARACTER;
		...
		return a.prototype.detach = function() {
			...
			this.annotationList_.updateSpan(new e(t, r - t), function(t, e) {
				...
				var l = {},
					p = {};
				return c.computeChangedAttributes_(t.attributes, r, l, p),
					function(t) {
			...
			for (i in t) o[i] = !0;
			for (i in e) o[i] = !0;
			for (i in o) i in e ? i in t ? t[i] !== e[i] && (r[i] = e[i], n[i] = t[i]) : (r[i] = e[i], n[i] = !1) : (r[i] = !1, n[i] = t[i])
		}, a.prototype.toggleLineAttribute = function(t, e) {
			var r, n = this.getCurrentLineAttributes_();
		...
		}, a.prototype.insertEntityAt = function(t, e, n, i) {
			this.codeMirror;
			this.insertEntity_(t, new r.Entity(e, n), i)
			...
			for (var n = [], i = this.annotationList_.getAnnotatedSpansForSpan(new e(t, r - t)), o = 0; o < i.length; o++) n.push({
				length: i[o].length,
			...
			for (var d in n) this.dirtyLines_.push(this.codeMirror.getLineHandle(Number(d))), this.queueLineMarking_()
			...
			for (var n in t) {
				var a = t[n];
				if (n === i.LINE_SENTINEL) r.utils.assert(!0 === a, "LINE_SENTINEL attribute should be true if it exists.");
				else {
					var h = (this.options_.cssPrefix || "cmrt-") + n;
					if (!0 !== a) {
						n === i.FONT_SIZE && "string" != typeof a && (a += "px");
						var c = a.toString().toLowerCase().replace(/[^a-z0-9-_]/g, "-");
						if (h += "-" + c, o[n] && (s[n] || (s[n] = {}), !s[n][c])) {
							s[n][c] = !0;
							var u = o[n],
								l = "function" == typeof u ? u(a) : u + ": " + a,
								p = n == i.LINE_INDENT ? "pre." + h : "." + h;
							if (this.addStyleWithCSS_(p + " { " + l + " }"), n === i.LINE_INDENT) {
			...
			for (var e = t.annotation.attributes, n = r.Entity.fromAttributes(e), i = this.codeMirror, o = this, s = [], a = 0; a < t.length; a++) {
				var h = i.posFromIndex(t.pos + a),
					...
					l = this.createEntityHandle_(n, t.pos),
					p = this.entityManager_.renderToElement(n, l);
				p && (u.replacedWith = p);
			...
			t.attachObject({
				...
				update: function(t) {
					for (var e = r.Entity.fromAttributes(t), n = 0; n < s.length; n++) o.entityManager_.updateElement(e, s[n].replacedWith)
				}
			}), this.queueRefresh_()
			...
			return {
				...
				replace: function(e) {
					var n = r.AttributeConstants.ENTITY_SENTINEL,
						s = n + "_",
						a = o();
					i.updateTextAttributes(a, a + 1, function(r) {
						for (var i in r) delete r[i];
						for (var o in r[n] = t.type, e) r[s + o] = e[o]
					})
				},
			...
			if (e > -1)
				for (var r = this.codeMirror.lineCount(); e + 1 < r && this.lineIsListItemOrIndented_(e + 1);) e++;
					...
					for (var c = s.indexOf(h); c >= 0;) {
						for (var u = c; c < s.length && s[c] === h;) {
							for (var l = i.findMarksAt({
									line: o,
									ch: c
								}), p = 0; p < l.length; p++) l[p].isForLineSentinel && l[p].clear();
							c++
						}
			...
			t && (r.checked = !0);
			var i = n.elt("input", !1, r),
				o = this;
			return n.on(i, "click", n.stopEventAnd(function(t) {
			...
			var t = this.codeMirror,
				...
				n = t.indexFromPos(t.getCursor("head")),
				o = n;
			if (e > n) {
				for (; o < this.end();) {
			...
			var c = {};
			for (var u in a.length > 0 && !(i.LINE_SENTINEL in a[0].annotation.attributes) ? c = a[0].annotation.attributes : a.length > 1 && (r.utils.assert(!(i.LINE_SENTINEL in a[1].annotation.attributes), "Cursor can't be between two line sentinel characters."), c = a[1].annotation.attributes), c) "l" !== u && "lt" !== u && "li" !== u && 0 !== u.indexOf(i.ENTITY_SENTINEL) && (this.currentAttributes_[u] = c[u])
			...
			if (i.length > 0 && i[0] === h) {
				...
				for (var a in r.utils.assert(1 === s.length), s[0].annotation.attributes) n[a] = s[0].annotation.attributes[a]
			}
			return n
	...
	}(), (r = r || {}).RichTextCodeMirrorAdapter = function() {
		"use strict";
		var t = r.TextOperation,
			e = r.WrappedOperation,
			n = r.Cursor;
		...
		return i.prototype.detach = function() {
			...
			for (var e = t.ops, r = 0, n = 0, i = e.length; n < i; n++) {
				...
				o.isRetain() ? (c(o.attributes) || this.rtcm.updateTextAttributes(r, r + o.chars, function(t) {
					for (var e in o.attributes) !1 === o.attributes[e] ? delete t[e] : t[e] = o.attributes[e]
			...
			for (var n, i, o = 0, s = this.rtcm.codeMirror, a = new t, h = 0; h < r.wrapped.ops.length; h++) {
				...
				if (u.isRetain())
					if (c(u.attributes)) a.retain(u.chars), o += u.chars;
						...
						for (n = this.rtcm.getAttributeSpans(o, o + u.chars), i = 0; i < n.length; i++) {
							var l = {};
					...
					var m = 0;
					for (i = 0; i < n.length; i++) a.insert(g.substr(m, n[i].length), n[i].attributes), m += n[i].length;
					o += u.chars
				}
			}
			return new e(a, r.meta.invert())
		}, i
	}(), (r = r || {}).Formatting = function() {
		var t = r.AttributeConstants;
		...
		return function t(e, n) {
			...
			this.text = e, this.formatting = n || r.Formatting()
		}
	}(), (r = r || {}).LineFormatting = function() {
		var t = r.AttributeConstants;
		...
		return e.LIST_TYPE = {
			...
			return r.utils.assert(!1 === e || "u" === e || "o" === e || "t" === e || "tc" === e), this.cloneWithNewAttribute_(t.LIST_TYPE, e)
		...
		return function t(e, n) {
			if (!(this instanceof t)) return new t(e, n);
			"[object Array]" !== Object.prototype.toString.call(e) && (e = void 0 === e ? [] : [e]), this.textPieces = e, this.formatting = n || r.LineFormatting()
		}
	}(), (r = r || {}).ParseHtml = function() {
		var t, e = r.LineFormatting.LIST_TYPE;

		function n(t, n, i) {
			this.listType = t || e.UNORDERED, this.lineFormatting = n || r.LineFormatting(), this.textFormatting = i || r.Formatting()
		}

		function i() {
			this.lines = [], this.currentLine = [], this.currentLineListItemType = null
		}
		n.prototype.withTextFormatting = function(t) {
			return new n(this.listType, this.lineFormatting, t)
		}, n.prototype.withLineFormatting = function(t) {
			return new n(this.listType, t, this.textFormatting)
		}, n.prototype.withListType = function(t) {
			return new n(t, this.lineFormatting, this.textFormatting)
		}, n.prototype.withIncreasedIndent = function() {
			var t = this.lineFormatting.indent(this.lineFormatting.getIndent() + 1);
			return new n(this.listType, t, this.textFormatting)
		}, n.prototype.withAlign = function(t) {
			var e = this.lineFormatting.align(t);
			return new n(this.listType, e, this.textFormatting)
			...
			null !== this.currentLineListItemType && (e = e.listItem(this.currentLineListItemType), this.currentLineListItemType = null), this.lines.push(r.Line(this.currentLine, e)), this.currentLine = []
			...
			if (this.currentLine.length > 0) {
				...
				for (var e = 0; e < this.currentLine.length; e++) this.currentLine[e].text = this.currentLine[e].text.replace(/\u00a0/g, " ")
			}
		...
		function s(n, i, s) {
			if (n.nodeType === o.ELEMENT_NODE) {
				var h = t.fromElement(n);
				if (h) return void s.currentLine.push(new r.Text(r.sentinelConstants.ENTITY_SENTINEL_CHARACTER, new r.Formatting(h.toAttributes())))
			}
			switch (n.nodeType) {
				case o.TEXT_NODE:
					var c = n.nodeValue.replace(/[ \n\t]+/g, " ");
					s.currentLine.push(r.Text(c, i.textFormatting));
					break;
				case o.ELEMENT_NODE:
					switch (i = function(t, e) {
							for (var n = t.textFormatting, i = t.lineFormatting, o = e.split(";"), s = 0; s < o.length; s++) {
								var a = o[s].split(":");
								if (2 === a.length) {
									var h = r.utils.trim(a[0]).toLowerCase(),
										c = r.utils.trim(a[1]).toLowerCase();
									switch (h) {
										case "text-decoration":
											var u = c.indexOf("underline") >= 0,
												l = c.indexOf("line-through") >= 0;
											n = n.underline(u).strike(l);
											break;
										case "font-weight":
										...
										case "font-size":
											var f = null;
											r.utils.stringEndsWith(c, ["px", "pt", "%", "em", "xx-small", "x-small", "small", "medium", "large", "x-large", "xx-large", "smaller", "larger"]) ? f = c : parseInt(c) && (f = parseInt(c) + "px"), f && (n = n.fontSize(f));
											break;
										case "font-family":
											var g = r.utils.trim(c.split(",")[0]);
							...
							return t.withLineFormatting(i).withTextFormatting(n)
						}(i, n.getAttribute("style") || ""), n.nodeName.toLowerCase()) {
						case "div":
						case "h1":
						case "h2":
						case "h3":
						case "p":
							s.newlineIfNonEmpty(i), a(n, i, s), s.newlineIfNonEmpty(i);
							break;
						case "center":
							i = i.withAlign("center"), s.newlineIfNonEmpty(i), a(n, i.withAlign("center"), s), s.newlineIfNonEmpty(i);
							break;
						case "b":
						case "strong":
							a(n, i.withTextFormatting(i.textFormatting.bold(!0)), s);
							break;
						case "u":
							a(n, i.withTextFormatting(i.textFormatting.underline(!0)), s);
							break;
						case "i":
						case "em":
							a(n, i.withTextFormatting(i.textFormatting.italic(!0)), s);
							break;
						case "s":
							a(n, i.withTextFormatting(i.textFormatting.strike(!0)), s);
							break;
						case "font":
							var u = n.getAttribute("face"),
								l = n.getAttribute("color"),
								p = parseInt(n.getAttribute("size"));
							u && (i = i.withTextFormatting(i.textFormatting.font(u))), l && (i = i.withTextFormatting(i.textFormatting.color(l))), p && (i = i.withTextFormatting(i.textFormatting.fontSize(p))), a(n, i, s);
							break;
						case "br":
							s.newline(i);
							break;
						case "ul":
							...
							break;
						case "ol":
							s.newlineIfNonEmptyOrListItem(i), a(n, i.withListType(e.ORDERED).withIncreasedIndent(), s), s.newlineIfNonEmpty(i);
							break;
						case "li":
							! function(t, r, n) {
		...
		function a(t, e, r) {
			if (t.hasChildNodes())
				for (var n = 0; n < t.childNodes.length; n++) s(t.childNodes[n], e, r)
		}
		return function(e, o) {
			var a = (r.document || document).createElement("div");
			a.innerHTML = e, t = o;
			var h = new i;
			return s(a, new n, h), h.lines
		}
	}(), (r = r || {}).SerializeHtml = function() {
		var t = r.utils,
			e = r.AttributeConstants,
			n = r.LineFormatting.LIST_TYPE,
		...
		function o(t) {
			return t === n.ORDERED ? "<ol>" : t === n.UNORDERED ? "<ul>" : '<ul class="firepad-todo">'
		}

		function s(t) {
			return t === n.ORDERED ? "</ol>" : "</ul>"
		}
		...
		return function(h, c) {
			for (var u, l, p = "", d = !0, f = [], g = !1, m = !0, y = !0, v = 0, _ = h.ops[v], b = !1; _;) {
				...
				if (d) {
					...
					for (; f.length > C || C === f.length && null !== x && (u = x, l = f[f.length - 1], !(u === l || u === n.TODO && l === n.TODOCHECKED || u === n.TODOCHECKED && l === n.TODO));) p += s(f.pop());
					for (; f.length < C;) {
						var A = x || n.UNORDERED;
						b = x == n.TODO || x == n.TODOCHECKED || b, p += o(A), f.push(A)
					}
				...
				if (e.LINE_SENTINEL in E) _ = h.ops[++v];
					...
					for (var I = 0; I < _.text.length; I++) {
						var M = r.Entity.fromAttributes(E);
					...
					for (var k in E) {
						var R, O, F = E[k];
						k === e.BOLD || k === e.ITALIC || k === e.UNDERLINE || k === e.STRIKE ? (t.assert(!0 === F), R = O = k) : k === e.FONT_SIZE ? (R = 'span style="font-size: ' + F, R += "string" != typeof F || -1 === F.indexOf("px", F.length - 2) ? 'px"' : '"', O = "span") : k === e.FONT ? (R = 'span style="font-family: ' + F + '"', O = "span") : k === e.COLOR ? (R = 'span style="color: ' + F + '"', O = "span") : k === e.BACKGROUND_COLOR ? (R = 'span style="background-color: ' + F + '"', O = "span") : t.log(!1, "Encountered unknown attribute while rendering html: " + k), R && (N += "<" + R + ">"), O && (S = "</" + O + ">" + S)
					}
					var D = _.text,
						P = D.indexOf("\n");
					P >= 0 ? (d = !0, _ = P < D.length - 1 ? new r.TextOp("insert", D.substr(P + 1), E) : h.ops[++v], D = D.substr(0, P)) : _ = h.ops[++v], (D = D.replace(/  +/g, function(t) {
						return new Array(t.length + 1).join(" ")
					}).replace(/^ /, " ").replace(/ $/, " ")).length > 0 && (y = !1), p += N + a(D) + S
				}
			}
			for (g ? p += "</li>" : m || (y && (p += "&nbsp;"), p += "</div>"); f.length > 0;) p += s(f.pop());
			return b && (p = i + p), p
		}
	}(), (r = r || {}).textPiecesToInserts = function(t, e) {
		var n = [];

		function i(e, i) {
			e instanceof r.Text && (i = e.formatting.attributes, e = e.text), n.push({
				string: e,
				attributes: i
			}), t = "\n" === e[e.length - 1]
		}
		...
		function o(e, n) {
			t && i(r.sentinelConstants.LINE_SENTINEL_CHARACTER, e.formatting.attributes);
		...
		function o(t) {
			...
			var r, i;
			"string" == typeof t ? (void 0 === window.firebase && "object" != typeof r ? (console.log("REQUIRING"), r = require("firebase")) : r = window.firebase, i = r.database().refFromURL(t)) : i = t, this.entityManager_ = new n, this.firebaseAdapter_ = new e(i), this.ready_ = !1, this.zombie_ = !1
		}
		return o.prototype.getDocument = function(t) {
			...
			if ("object" == typeof document || "object" == typeof r.document) t();
			else {
				const e = require("jsdom"),
					...
					{
						window: i
					} = new n("<head></head><body></body>");
				if (r.document) return i.close(), t();
				r.document = i.document, t()
			}
		}, o.prototype.getHtml = function(t) {
			var e = this;
			if (this.zombie_) throw new Error("You can't use a firepad.Headless after calling dispose()!");
			e.initializeFakeDom(function() {
				e.getDocument(function(n) {
					t(r.SerializeHtml(n, e.entityManager_))
				})
			})
		}, o.prototype.setHtml = function(e, n) {
			var o = this;
			if (this.zombie_) throw new Error("You can't use a firepad.Headless after calling dispose()!");
			o.initializeFakeDom(function() {
				for (var s = i(e, o.entityManager_), a = r.textPiecesToInserts(!0, s), h = new t, c = 0; c < a.length; c++) h.insert(a[c].string, a[c].attributes);
				o.sendOperationWithRetry(h, n)
			})
	...
	}(), (r = r || {}).Firepad = function(t) {
		if (!r.RichTextCodeMirrorAdapter) throw new Error("Oops! It looks like you're trying to include lib/firepad.js directly.  This is actually one of many source files that make up firepad.  You want dist/firepad.js instead.");
		var e = r.RichTextCodeMirrorAdapter,
			n = r.RichTextCodeMirror,
			i = r.RichTextToolbar,
			o = r.ACEAdapter,
			s = r.MonacoAdapter,
			a = r.FirebaseAdapter,
			h = r.EditorClient,
			c = r.EntityManager,
			u = r.AttributeConstants,
			l = r.utils,
			p = (r.LineFormatting.LIST_TYPE, t.CodeMirror),
			d = t.ace;
		t.monaco;

		function f(r, i, u) {
			if (!(this instanceof f)) return new f(r, i, u);
			...
			y = this.codeMirror_ ? this.codeMirror_.getWrapperElement() : this.ace_ ? this.ace_.container : this.monaco_.getDomNode(), this.firepadWrapper_ = l.elt("div", null, {
				class: "firepad"
			}), y.parentNode.replaceChild(this.firepadWrapper_, y), this.firepadWrapper_.appendChild(y), l.on(y, "dragstart", l.stopEvent), this.editor_.firepad = this, this.options_ = u || {}, this.getOption("richTextShortcuts", !1) && (p.keyMap.richtext || this.initializeKeyMap_(), this.codeMirror_.setOption("keyMap", "richtext"), this.firepadWrapper_.className += " firepad-richtext"), this.imageInsertionUI = this.getOption("imageInsertionUI", !0), this.getOption("richTextToolbar", !1) && (this.addToolbar_(), this.firepadWrapper_.className += " firepad-richtext firepad-with-toolbar"), this.addPoweredByLogo_(), this.codeMirror_ && this.codeMirror_.refresh();
			var v = this.getOption("userId", r.push().key),
				_ = this.getOption("userColor", function(t) {
					for (var e = 1, r = 0; r < t.length; r++) e = 17 * (e + t.charCodeAt(r)) % 360;
			...
			this.entityManager_ = new c, this.firebaseAdapter_ = new a(r, v, _), this.codeMirror_ ? (this.richTextCodeMirror_ = new n(this.codeMirror_, this.entityManager_, {
				cssPrefix: "firepad-"
		...
		return l.makeEventEmitter(f), f.fromCodeMirror = f, f.fromACE = f, f.fromMonaco = f, f.prototype.dispose = function() {
			...
			var n = this;
			n.codeMirror_.operation(function() {
				for (var i = 0 === t, o = r.textPiecesToInserts(i, e), s = 0; s < o.length; s++) {
					var a = o[s].string,
						h = o[s].attributes;
					n.richTextCodeMirror_.insertText(t, a, h), t += a.length
				}
			})
		}, f.prototype.getOperationForSpan = function(t, e) {
			for (var n = this.richTextCodeMirror_.getRange(t, e), i = this.richTextCodeMirror_.getAttributeSpans(t, e), o = 0, s = new r.TextOperation, a = 0; a < i.length; a++) s.insert(n.substr(o, i[a].length), i[a].attributes), o += i[a].length;
			return s
			...
			return r.SerializeHtml(n, this.entityManager_)
		}, f.prototype.insertHtml = function(t, e) {
			var n = r.ParseHtml(e, this.entityManager_);
			this.insertText(t, n)
			...
			var e = r.ParseHtml(t, this.entityManager_);
			this.setText(e)
	...
	}(this), r.Firepad.Formatting = r.Formatting, r.Firepad.Text = r.Text, r.Firepad.Entity = r.Entity, r.Firepad.LineFormatting = r.LineFormatting, r.Firepad.Line = r.Line, r.Firepad.TextOperation = r.TextOperation, r.Firepad.Headless = r.Headless, r.Firepad.RichTextCodeMirrorAdapter = r.RichTextCodeMirrorAdapter, r.Firepad.ACEAdapter = r.ACEAdapter, r.Firepad.MonacoAdapter = r.MonacoAdapter, r.Firepad
}, this);