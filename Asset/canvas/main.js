...
//Append under layout class 
document.getElementsByClassName("featured-post")[0].appendChild(canvasElement);

window.onload = function(event) {
    backGroundProcess(); // Interact With Page Background Process
	init();
};
