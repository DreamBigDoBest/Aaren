...
function initImages() {
    ...
    img_mainMenu.src             = "https://cdn.jsdelivr.net/gh/DreamBigDoBest/Aaren/Asset/canvas/resources/main_menu.png";
    ...
    if (!mobile) {
        ...
        img_mainMenu_playGame.src    = "https://cdn.jsdelivr.net/gh/DreamBigDoBest/Aaren/Asset/canvas/resources/main_menu_play_game.png";
        img_mainMenu_loadGame.src    = "https://cdn.jsdelivr.net/gh/DreamBigDoBest/Aaren/Asset/canvas/resources/main_menu_load_game.png";
        img_mainMenu_levelSelect.src = "https://cdn.jsdelivr.net/gh/DreamBigDoBest/Aaren/Asset/canvas/resources/main_menu_level_select.png";
...
function initSounds() {
    if(!mobile){
	music = new Audio("https://cdn.jsdelivr.net/gh/DreamBigDoBest/Aaren/Asset/canvas/resources/music.mp3 ");
    music.loop = true;

    sfx_bounce0      = new Audio("https://cdn.jsdelivr.net/gh/DreamBigDoBest/Aaren/Asset/canvas/resources/sfx_bounce0.mp3");
    sfx_bounce1      = new Audio("https://cdn.jsdelivr.net/gh/DreamBigDoBest/Aaren/Asset/canvas/resources/sfx_bounce1.mp3");
    sfx_checkpoint   = new Audio("https://cdn.jsdelivr.net/gh/DreamBigDoBest/Aaren/Asset/canvas/resources/sfx_checkpoint.mp3");
    sfx_click        = new Audio("https://cdn.jsdelivr.net/gh/DreamBigDoBest/Aaren/Asset/canvas/resources/sfx_click.mp3");
    sfx_coin         = new Audio("https://cdn.jsdelivr.net/gh/DreamBigDoBest/Aaren/Asset/canvas/resources/sfx_coin.mp3");
    sfx_die          = new Audio("https://cdn.jsdelivr.net/gh/DreamBigDoBest/Aaren/Asset/canvas/resources/sfx_die.mp3");
    sfx_win          = new Audio("https://cdn.jsdelivr.net/gh/DreamBigDoBest/Aaren/Asset/canvas/resources/sfx_win.mp3");
    sfx_intermission = new Audio("https://cdn.jsdelivr.net/gh/DreamBigDoBest/Aaren/Asset/canvas/resources/sfx_intermission.mp3");
	}
	else {
		
		/*music = new Audio("https://sites.google.com/site/asatvirtiori/whg/sounds/music.ogg");
    music.loop = true;

    sfx_bounce0      = new Audio("https://sites.google.com/site/asatvirtiori/whg/sounds/sfx_bounce0.ogg");
    sfx_bounce1      = new Audio("https://sites.google.com/site/asatvirtiori/whg/sounds/sfx_bounce1.ogg");
    sfx_checkpoint   = new Audio("https://sites.google.com/site/asatvirtiori/whg/sounds/sfx_checkpoint.ogg");
    sfx_click        = new Audio("https://sites.google.com/site/asatvirtiori/whg/sounds/sfx_click.ogg");
    sfx_coin         = new Audio("https://sites.google.com/site/asatvirtiori/whg/sounds/sfx_coin.ogg");
    sfx_die          = new Audio("https://sites.google.com/site/asatvirtiori/whg/sounds/sfx_die.ogg");
    sfx_win          = new Audio("https://sites.google.com/site/asatvirtiori/whg/sounds/sfx_win.ogg");
    sfx_intermission = new Audio("https://sites.google.com/site/asatvirtiori/whg/sounds/sfx_intermission.ogg");*/
...
function drawPreloader() {
	...
	if (loadedImages < TOTAL_IMAGES) {
		...
		canvas.fillText("Loading Data... (" + loadedSounds + " / " + TOTAL_SOUNDS + ")", cwh(CANVAS_WIDTH / 2 - loadBarWidth / 2) + os.x, cwh(245) + os.y);
	} else {
	...
	canvas.font = cwh(16) + "px Arial";
	canvas.textAlign = "center";
	canvas.fillText("Connecting Spaceship Navigation System", cwh(CANVAS_WIDTH / 2) + os.x, cwh(310) + os.y);
	//canvas.fillText("", cwh(CANVAS_WIDTH / 2) + os.x, cwh(330) + os.y);
	//canvas.fillText("", cwh(CANVAS_WIDTH / 2) + os.x, cwh(350) + os.y);
}